...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/output.css":
/*!********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/output.css ***!
  \********************************************************************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_output_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!../node_modules/postcss-loader/dist/cjs.js!./output.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/output.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_output_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_output_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_output_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_output_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
function Header() {
    ...
    headerDom.classList.add("bg-sky-300", "flex", "justify-center");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.apiGetCountryDetails = exports.apiGetAllCountries = void 0;
...
const apiGetAllCountries = () => {
    return getData(apiUrl + urlAllCountries);
};
exports.apiGetAllCountries = apiGetAllCountries;
const apiGetCountryDetails = (country) => {
    return getData(apiUrl + urlFindByCountry + country);
};
exports.apiGetCountryDetails = apiGetCountryDetails;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.render = exports.pick6RandomCountries = void 0;
const Header_1 = __importDefault(__webpack_require__(/*! ./Header */ "./src/Header.ts"));
const root = document.getElementById('root');
function pick6RandomCountries(countries) {
    const maxIndex = countries.length - 1;
    let countries6 = [];
    for (let i = 0; i < 6; i++)
        countries6.push(countries[Math.floor((maxIndex + 1) * Math.random())]);
    return countries6;
}
exports.pick6RandomCountries = pick6RandomCountries;
function render(countries) {
    var _a;
    (0, Header_1.default)();
    console.log("Rabbit in the headlights");
    ...
    (_a = document.getElementById("root")) === null || _a === void 0 ? void 0 : _a.append(ul);
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.renderGameInterface = void 0;
function renderGameInterface() {
    const root = document.getElementById('root');
    const question = document.createElement('div');
    question.classList.add("bg-orange-300");
    question.innerText = "Estonia";
    if (root !== null)
        root.append(question);
}
exports.renderGameInterface = renderGameInterface;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setSelected6countries = void 0;
const api_service_1 = __webpack_require__(/*! ./api-service */ "./src/api-service.ts");
const rxjs_1 = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/cjs/index.js");
const businessLogic_1 = __webpack_require__(/*! ./businessLogic */ "./src/businessLogic.ts");
const businessLogic_2 = __webpack_require__(/*! ./businessLogic */ "./src/businessLogic.ts");
const gameInterface_1 = __webpack_require__(/*! ./gameInterface */ "./src/gameInterface.ts");
__webpack_require__(/*! ./output.css */ "./src/output.css");
/*
...
const subscription = (0, api_service_1.apiGetCountryDetails)("latvia").subscribe({
    next: data => {
...
let allCountries;
let selected6countries;
const countriesSub = (0, api_service_1.apiGetAllCountries)()
    .pipe((0, rxjs_1.map)(countryArr => countryArr.map((country) => country.name.common)), (0, rxjs_1.tap)((countries) => setSelected6countries((0, businessLogic_1.pick6RandomCountries)(countries))))
    .subscribe({
    next: data => allCountries = data,
    error: error => console.error('Error fetching data: ', error),
    complete: () => countriesSub.unsubscribe()
});
function setSelected6countries(new6) {
    selected6countries = new6;
    (0, gameInterface_1.renderGameInterface)();
    (0, businessLogic_2.render)(new6);
}
exports.setSelected6countries = setSelected6countries;

})();

/******/ })()
;
//# sourceMappingURL=bundle44ecac616e74aafc114c.js.map